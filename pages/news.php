        ...
        <?php foreach($blog_list as $blog): ?>
            <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6 col-blog-mobile">
                <section class="post">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="image"><a href="/news/read/<?php echo preg_replace('/[a-zA-Z]/', '', $blog['post_id']); ?>"><img src="https://webdev.nisgaa.bc.ca/images/thumbnails/<?php echo $blog['post_thumbnail']; ?>" alt="..." class="img-fluid"></a></div>
                        </div>
                        <div class="col-md-9">
